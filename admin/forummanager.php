...
$r1 = mysql_query('select f.name as f_name, f.id as fid, f.description,f.minclassread,f.minclasswrite, f.minclasscreate, o.name as o_name,o.id as oid FROM forums as f LEFT JOIN overforums as o ON f.forid = o.id ORDER BY f.sort') or  sqlerr(__FILE__,__LINE__);
...
$htmlout .= stdmsg('Err','There are no topics, maybe you should add some');
	...
	$r2 = mysql_query('SELECT id,name FROM overforums ORDER BY name') or sqlerr(__FILE__,__LINE__);
