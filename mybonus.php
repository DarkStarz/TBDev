    ...
    *note if they try to use a restricted word, they will recieve the special title "I just wasted my karma" *****/
    ...
    <tr>
    <td style='background:transparent;height:25px;' align='left'>{$lang['bonus_head_descr']}</td>
    <td style='background:transparent;height:25px;' align='center'>{$lang['bonus_head_points']}</td>
    <td style='background:transparent;height:25px;' align='center'>{$lang['bonus_head_trade']}</td></tr>";
