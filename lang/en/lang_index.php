...
'stats_sl_ratio' 				=> "Seeder/leecher ratio (%)",
    ...
    'index_active' => "Online Members",
    'index_noactive' => "Sorry - No users active presently",	
#disclaimer
'foot_disclaimer' 			=> "None of the files shown here are actually hosted on this server.
                                The links are provided solely by this site's users. The administrator of this site (scenezone) cannot be held responsible for what its users post,
                                or any other actions of its users. You may not use this site to distribute or download any material when you do not have the legal rights to do so.
